...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="mb-0 text-gray-600">Bienvenue, <?php echo e(Auth::user()->name); ?> - <span class="badge badge-danger">Administrateur</span></p>
        </div>
        <div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(\App\Models\User::count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(\App\Models\User::where('status', 'active')->count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(\App\Models\User::where('status', 'inactive')->count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = \App\Models\User::orderBy('created_at', 'desc')->limit(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn btn-info btn-sm">
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\abous\OneDrive\Bureau\bookShare\bookShare\projet_laravel\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>