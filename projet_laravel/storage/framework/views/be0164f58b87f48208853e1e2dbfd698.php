    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="<?php echo e(asset('images/bookshare_logo.png')); ?>" alt="BookShare Logo">
                BookShare
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="nav-link-custom" href="<?php echo e(url('/dashboard')); ?>">
                                <i class="fas fa-home me-1"></i>Dashboard
                            </a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link-custom" href="<?php echo e(route('login')); ?>">
                                <i class="fas fa-sign-in-alt me-1"></i>Connexion
                            </a>
                        </li>
                        <?php if(Route::has('register')): ?>
                            <li class="nav-item">
                                <a class="nav-link-custom" href="<?php echo e(route('register')); ?>">
    ...
    <div class="hero-container" style="margin-top: 100px;">
        <div class="hero-card">
            <div class="hero-content">
                ...
                <div>
                    <a href="<?php echo e(route('register')); ?>" class="btn-hero btn-primary-hero">
                        <i class="fas fa-rocket me-2"></i>Commencer
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-hero btn-outline-hero">
                        <i class="fas fa-book-open me-2"></i>Découvrir
                    </a>
                </div>
            </div>
            <div class="hero-image">
                <img src="<?php echo e(asset('images/bookshare_logo.png')); ?>" alt="BookShare">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-8" data-aos="fade-up">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-5 py-3 rounded-pill me-3">
    ...
    <footer class="footer-custom">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="footer-text">&copy; <?php echo e(date('Y')); ?> BookShare. Tous droits réservés.</p>
                </div>
...
<?php /**PATH C:\Users\Lenovo\Desktop\bookShare\projet_laravel\resources\views/welcome-bookshare.blade.php ENDPATH**/ ?>