        ...
        <div class="row min-vh-100 align-items-center">
            <div class="col-12">
                ...
                <div class="text-center text-white">
                    ...
                    <div class="mb-5">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-5 py-3 me-3">
                            <i class="fas fa-user-plus mr-2"></i>Rejoindre BookShare
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-lg px-5 py-3">
...
<?php /**PATH C:\Users\abous\OneDrive\Bureau\bookShare\bookShare\projet_laravel\resources\views/welcome-bookshare.blade.php ENDPATH**/ ?>