...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        <?php if(Route::has('password.request')): ?>
                                            <a class="small" href="<?php echo e(route('password.request')); ?>">Mot de passe oublié ?</a>
                                        <?php endif; ?>
                                    </div>
                                    
                                    <div class="text-center">
                                        <?php if(Route::has('register')): ?>
                                            <a class="small" href="<?php echo e(route('register')); ?>">Créer un compte !</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\abous\OneDrive\Bureau\bookShare\bookShare\projet_laravel\resources\views/auth/login-admin.blade.php ENDPATH**/ ?>