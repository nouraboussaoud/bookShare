...
<?php $__env->startSection('title', 'Modifier l\'Avis'); ?>
<?php $__env->startSection('content'); ?>
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Modifier l'Avis</h1>
            <p class="mb-0 text-gray-600">Modifier votre avis pour "<?php echo e($review->book->title); ?>"</p>
        </div>
        <a href="<?php echo e(route('reviews.index')); ?>" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
                    ...
                    <form action="<?php echo e(route('reviews.update', $review)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-plaintext bg-light p-2 rounded">
                                <strong><?php echo e($review->book->title); ?></strong> - <?php echo e($review->book->author); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="Modifiez votre opinion sur ce livre..."><?php echo e(old('comment', $review->comment)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="book-info">
                        <h5><?php echo e($review->book->title); ?></h5>
                        <p class="text-muted">par <?php echo e($review->book->author); ?></p>
                        ...
                        <?php endif; ?>
                        <hr>
                        <small class="text-info">Propriétaire: <?php echo e($review->book->user->name); ?></small>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if($review->comment): ?>
                        <div class="current-comment">
                            ...
                            <div class="bg-light p-2 rounded mt-1">
                                <small><?php echo e(Str::limit($review->comment, 100)); ?></small>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <small class="text-muted">
                        Créé le <?php echo e($review->created_at->format('d/m/Y à H:i')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const currentRating = <?php echo e($review->rating); ?>;
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\bookShare\projet_laravel\resources\views/reviews/edit.blade.php ENDPATH**/ ?>