        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('books.index')); ?>" class="btn btn-primary btn-block mb-2">
                        <i class="fas fa-search"></i> Parcourir les livres
                    </a>
                    <a href="<?php echo e(route('locations.index')); ?>" class="btn btn-outline-primary btn-block">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\bookShare\projet_laravel\resources\views/locations/help.blade.php ENDPATH**/ ?>