...
@section('title', 'BookShare - Historique des Échanges')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('exchanges.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Échanges</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $exchanges->count() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                            ...
                            <a class="dropdown-item" href="{{ route('exchanges.create') }}">
                                    ...
                                    <tr class="exchange-row" data-exchange-id="{{ $exchange->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('exchanges.show', $exchange->id) }}" 
                                                   class="btn btn-outline-info btn-sm" 
                                                   data-toggle="tooltip" 
                                                   title="Voir les détails">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($exchange->status !== 'TERMINE' && $exchange->status !== 'ANNULE')
                                                    <a href="{{ route('exchanges.edit', $exchange->id) }}" 
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                <a href="{{ route('exchanges.create') }}" class="btn btn-primary btn-lg shadow-sm">
